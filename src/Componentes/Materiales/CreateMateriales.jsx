...
const CreateMateriales = () => {
  ...
  function handleListaPrecioChange(e) {
    ...
    setLista_Precio_Material((prevFormData) => {
      ...
      if (listaSelected) {
        const porcentaje_descuento = listaSelected.descuento;
        const lista_name = listaSelected.name;
  ...
  function handlePrecioVentaChange(e) {
    ...
    setLista_Precio_Material((prevFormData) => {
      ...
      const descuento = precio_venta * lista_precio_material.porcentaje_descuento / 100
      return {
        ...prevFormData,
        precio_venta,
        descuento,
  ...
  async function createMaterial(e) {
    ...
    const { error: listaError } = await supabase.from("listas_precio_materiales").insert({
      lista_name: lista_precio_material.lista_name,
      ...
      porcentaje_descuento: lista_precio_material.descuento,
    });
