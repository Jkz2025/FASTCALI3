        ...
        <div className="max-w-4xl mx-auto my-8 mt-10 sm:w-auto">
            <div className="bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-lg shadow-lg p-6">
                <div className={`${styles.flexCenter} sm:ml-10 ml-0 sm:mt-0 mt-10`}>
                    ...
                    {showCreateButton && <><ButtonFastCali onClick={handleCreateCliente} text={`Crear Empleado`} />  <ButtonFastCali onClick={handleBuscarClick} text={`Buscar Empleado`} /></>}
...
export default EmpleadosSearchForm;